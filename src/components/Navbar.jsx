...
function Navbar({ session }) {
    return (
        <nav className='bg-[#212529] text-white p-5'>
            <div className='container mx-auto'>
                <div className='flex justify-between items-center'>
                    <div>
                        <Link href="/">Stock System</Link>
                    </div>
                    <ul className='flex'>
                        {!session ? (
                            <>
                            ...
                            <>
                                <li className='mx-3'><a href='/welcome' className='bg-[#8146FF] text-white border py-2 px-3 rounded-md text-lg my-2'>Profile</a></li>
