    ...
    <div>
      ...
      <div className='container mx-auto py-5'>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <input onChange={(e) => setConfirmPassword(e.target.value)} className='block bg-gray-300 p-2 my-2 rounded-md' type="password" placeholder='Confirm your name' />
            <button type='submit' className='bg-green-500 p-2 rounded-md text-white'>Sign Up</button>
        </form>
        <hr className='my-3' />
        <p>Do not have an account? go to <Link className='text-[#8146FF] hover:underline' href="/login">Login</Link> Page</p>
      </div>
    </div>
  )
}
